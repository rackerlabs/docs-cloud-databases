...
Cloud Identity service.  Include your username and
...
token ID
    ...
    will expire, unless it is revoked prior to the expiration. To get a new
    token, submit another authentication request. For more information, see
