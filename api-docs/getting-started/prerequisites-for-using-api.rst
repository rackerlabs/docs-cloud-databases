...
To run the getting started examples, gather the 
following information and complete any required configuration 
tasks.
...
- Configure environment variables for :ref:`cURL <configure-environment-variables>` or 
