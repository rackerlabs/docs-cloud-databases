...
latex_documents = [
  (master_doc, 'RackspaceCloudDatabasesDeveloperDoc.tex',
   'Rackspace Cloud Databases API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudDatabasesDeveloperDoc',
     'Rackspace Cloud Databases API Developer Guide', 'Rackspace', 1)
             ]
...
texinfo_documents = [
      (master_doc, 'RackspaceCloudDatabasesDeveloperDoc',
       'Rackspace Cloud Databases API Developer Guide', 'Rackspace',
       'RackspaceCloudDatabasesDeveloperDoc',
       'Learn about using the Rackspace Cloud Databases service.',
       'Miscellaneous'),
       ]
