...
project = 'Rackspace Cloud Databases'
copyright = '2016'
author = 'Rackspace'
...
# html_title = 'Rackspace Cloud Databases v1 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'Rackspace Cloud Databases v1 API'
...
htmlhelp_basename = 'docs-cloud-databasesdoc'
...
latex_documents = [
  (master_doc, 'docs-cloud-databases.tex',
   'Rackspace Cloud Databases API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Databases API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-databases',
   'Rackspace Cloud Databases API Documentation',
   'Rackspace', 'docs-cloud-databases',
   'Learn about using Rackspace Cloud Databases',
   'Miscellaneous'),
]
